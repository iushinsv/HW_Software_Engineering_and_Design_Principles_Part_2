...
Рабочее развёртывание приложения, подключенного к 4 сторонним сервисам.
...
Теги:12factorметодологияметодология разработкиsaasherokucloud platform
Хабы:SaaS / S+SВеб-разработка